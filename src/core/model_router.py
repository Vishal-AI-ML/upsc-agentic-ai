...
_REASONING_KEYWORDS = frozenset({
    "evaluate", "evaluation", "assess", "assessment", "critically", "critique",
    "analyse", "analyze", "analysis", "compare", "comparison", "contrast",
    "discuss", "elaborate", "explain", "essay", "mains", "differentiate",
    "examine", "justify", "derive", "prove", "reason", "reasoning", "plan",
    "strategy", "roadmap", "synthesise", "synthesize", "comprehensive",
    "detailed", "why", "how", "significance", "implications", "consequences",
    "samjhao", "samjha", "vistaar",
})
...
_LOOKUP_KEYWORDS = frozenset({
    "latest", "current", "today", "news", "date", "when", "result", "results",
    "notification", "cutoff", "recent", "upcoming", "deadline", "schedule",
})
